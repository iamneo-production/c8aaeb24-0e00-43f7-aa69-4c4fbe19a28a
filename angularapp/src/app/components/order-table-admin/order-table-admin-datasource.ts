...
/**
 * Data source for the OrderTableAdmin view. This class should
  ...
  private getSortedData(data: OrderTableAdminItem[]): OrderTableAdminItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        case 'bname': return compare(a.name, b.name, isAsc);
        case 'id': return compare(+a.id, +b.id, isAsc);
        case 'uid': return compare(a.name, b.name, isAsc);
        case 'price': return compare(+a.id, +b.id, isAsc);
        case 'quant': return compare(+a.id, +b.id, isAsc);
